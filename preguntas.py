...
def pregunta_02():
    ...
    x_train, x_test, y_train, y_test = train_test_split( x_tagged, y_tagged,
        test_size=0.1,
        random_state=12345,
    )
...
def pregunta_04():
    ...
    pipeline = Pipeline(
        steps=[("countVectorizer", countVectorizer), ("bernoulli", BernoulliNB())
        ],
    )
    ...
    # BernoulliNB.
    param_grid = {
        "bernoulli_alpha": np.arange(0.1, 1.1, 0.1),
    }
